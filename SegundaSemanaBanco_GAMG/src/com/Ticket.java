...
public class Ticket {
	...
	//Este va a ser un objeto para responder
	//Si una operación realizó con éxito o no
	//Es decir, crearemos métodos en nuestro cajero que devuelvan el 
	//valor de un ticket
	//Ejemplo creamos un método public Ticket despositar() en la clase 
	//cajero
