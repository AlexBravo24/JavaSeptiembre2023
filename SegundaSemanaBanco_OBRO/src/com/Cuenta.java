...
public class Cuenta {
	...
	public Cuenta(int numCuenta, String nombreCliente, double saldo, int nip, double saldoMin, double saldoMaximo,
			String tipoCuenta) {
		super();
	...
	public String toString() {
		return "Cuenta [numCuenta=" + numCuenta + ", nombreCliente=" + nombreCliente + ", saldo=" + saldo + ", nip="
				+ nip + ", saldoMin=" + saldoMin + ", saldoMaximo=" + saldoMaximo + ", tipoCuenta=" + tipoCuenta + "]";
	}
