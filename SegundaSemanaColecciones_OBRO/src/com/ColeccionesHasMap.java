...
public class ColeccionesHasMap {

	public static void main(String[] args) {
		
		// La interfaz Map asocia claves a valores almanecenados
		//Las claves no pueden duplicarse
		
		//Esto permite que los elementos se almacenen en pares
		
		//Declaramos un HashMap, el primer valor sera la llave o ID (identificador)
		//y el segundo valor sera el elemento a guardar
		...
		//Ejemplo de un HasMap en el que la llave es un tipo de dato String
		...
		//Imprimir un solo valor
		System.out.println(salarios.get("Oswaldo"));
