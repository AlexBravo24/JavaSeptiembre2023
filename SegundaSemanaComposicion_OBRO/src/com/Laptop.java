...
public class Laptop {
	...
	//Atributos que son objetos que forman parte de uno mas grande, en este caso, una Laptop
	//Necesitamos crear las clases para definir estos objetos
	//Y una vez las creamos, si estan dentro del mismo paquete
	//Se detectan en automatico como tipo de dato que sera atributo aqui
