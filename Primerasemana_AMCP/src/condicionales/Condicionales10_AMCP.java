...
public class Condicionales10_AMCP {
	...
	public static void main(String[] args) {
		...
		//Inicio el programa declaración de variables
		Scanner scanner = new Scanner (System.in);
		int mes;
		
		//Solicitud de datos al usuario
		System.out.println("El programa te devuelve el número de días del mes seleccionado");
