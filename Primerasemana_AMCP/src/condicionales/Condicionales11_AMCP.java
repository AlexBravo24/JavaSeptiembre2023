...
//		de la entrega
		...
		System.out.println("Calcula la tarifa para el envío según el peso y la zona de destino");
		...
		if (peso > 5) {
			...
			switch (zona) {
			case 1:
				System.out.println("El paquete de " + peso + " Kilogramos enviado a América del Norte sale por "
						+ (peso*24) + " euros.");
				break;
			case 2:
				System.out.println("El paquete de " + peso + " Kilogramos enviado a América Central sale por "
						+ (peso*20) + " euros.");
				break;
			case 3:
				System.out.println("El paquete de " + peso + " Kilogramos enviado a América del Sur sale por "
						+ (peso*21) + " euros.");
				break;
			case 4:
