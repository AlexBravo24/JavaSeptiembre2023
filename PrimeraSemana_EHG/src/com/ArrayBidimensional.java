...
public class ArrayBidimensional {
	...
	public static void main(String[] args) {
		...
		//lo podemos asemejar en una tabla
		...
		//Imprimir todos los valores de nuestro arreglo bidimensional
		...
		//La teoria dice que los arrays nos permite almacenar una determinada cantidad de datos de un tipo en comun
		//int, double, char, String (tipo de datos Objeto)
